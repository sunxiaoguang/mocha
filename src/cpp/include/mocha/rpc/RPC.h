#ifndef __MOCHA_RPC_H__
#define __MOCHA_RPC_H__ 1
...
private:
  ...
  {
    if (size_ == capacity_) {
      capacity_ = MOCHA_RPC_ALIGN(size_ + 1, 16);
...
inline const char *errorString(int32_t code) { return MochaRPCErrorString(code); }

typedef enum RPCLogLevel {
  RPC_LOG_LEVEL_TRACE = MOCHA_RPC_LOG_LEVEL_TRACE,
  RPC_LOG_LEVEL_DEBUG = MOCHA_RPC_LOG_LEVEL_DEBUG,
  RPC_LOG_LEVEL_INFO = MOCHA_RPC_LOG_LEVEL_INFO,
  RPC_LOG_LEVEL_WARN = MOCHA_RPC_LOG_LEVEL_WARN,
  RPC_LOG_LEVEL_ERROR = MOCHA_RPC_LOG_LEVEL_ERROR,
  RPC_LOG_LEVEL_FATAL = MOCHA_RPC_LOG_LEVEL_FATAL,
  RPC_LOG_LEVEL_ASSERT = MOCHA_RPC_LOG_LEVEL_ASSERT,
} RPCLogLevel;
...
typedef MochaRPCOpaqueData RPCOpaqueData;
typedef MochaRPCOpaqueDataSink RPCOpaqueDataSink;
typedef MochaRPCOpaqueDataDestructor RPCOpaqueDataDestructor;
...
typedef enum MochaRPCEventType EventType;

typedef enum RPCEventType {
  EVENT_TYPE_CHANNEL_CREATED = (MOCHA_RPC_EVENT_TYPE_CHANNEL_CREATED),
  EVENT_TYPE_CHANNEL_LISTENING = (MOCHA_RPC_EVENT_TYPE_CHANNEL_LISTENING),
  EVENT_TYPE_CHANNEL_CONNECTED = (MOCHA_RPC_EVENT_TYPE_CHANNEL_CONNECTED),
  EVENT_TYPE_CHANNEL_ESTABLISHED = (MOCHA_RPC_EVENT_TYPE_CHANNEL_ESTABLISHED),
  EVENT_TYPE_CHANNEL_DISCONNECTED = (MOCHA_RPC_EVENT_TYPE_CHANNEL_DISCONNECTED),
  EVENT_TYPE_CHANNEL_REQUEST = (MOCHA_RPC_EVENT_TYPE_CHANNEL_REQUEST),
  EVENT_TYPE_CHANNEL_RESPONSE = (MOCHA_RPC_EVENT_TYPE_CHANNEL_RESPONSE),
  EVENT_TYPE_CHANNEL_PAYLOAD = (MOCHA_RPC_EVENT_TYPE_CHANNEL_PAYLOAD),
  EVENT_TYPE_CHANNEL_ERROR = (MOCHA_RPC_EVENT_TYPE_CHANNEL_ERROR),
  EVENT_TYPE_CHANNEL_DESTROYED = (MOCHA_RPC_EVENT_TYPE_CHANNEL_DESTROYED),
  EVENT_TYPE_SERVER_CREATED = (MOCHA_RPC_EVENT_TYPE_SERVER_CREATED),
  EVENT_TYPE_SERVER_DESTROYED = (MOCHA_RPC_EVENT_TYPE_SERVER_DESTROYED),
  EVENT_TYPE_ALL = (MOCHA_RPC_EVENT_TYPE_ALL),
} RPCEventType;

typedef MochaRPCErrorEventData ErrorEventData;
...
typedef MochaRPCPayloadEventData PayloadEventData;
