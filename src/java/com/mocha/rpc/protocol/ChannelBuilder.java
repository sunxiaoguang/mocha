...
public final class ChannelBuilder
{
  ...
  static {
    try {
      clientChannelConstructor = Class.forName("com.mocha.rpc.protocol.impl.ClientChannel")
    ...
    try {
      serverChannelConstructor = Class.forName("com.mocha.rpc.protocol.impl.ServerChannel")
        .getDeclaredConstructor(String.class, ChannelListener.class, InetSocketAddress.class, int.class, int.class, int.class, boolean.class, Object.class);
    } catch (Throwable ignored) {
    }
  }
